describe("Connect to site", () => {
  it("Assist test site: 'moovie'", () => {
    ...
    cy.get(
      ...
      .select("Drama") // select Drama from menu
      .wait(1500)
      .select("Comedy")
      .wait(1500)
      .select("Action");
    ...
    cy.get("#email").type("alexandra.ursu@assist.ro");
    ...
    //cy.get("#footerRow > div:nth-child(3) > ul > li:nth-child(3) > button").click();
    ...
    cy.visit("http://20.52.181.242:3000/");
    cy.get(
      "#footerRow > div:nth-child(3) > ul > li:nth-child(3) > button"
    ).click();
